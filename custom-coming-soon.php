                        ...
                        <div>
                            <div style="width: 80%; padding: 10px; margin: 10px;"> 
                                <h1>Custom Coming Soon Page & maintenance Settings</h1>
                                    ...
                                    <div style="float:right;color:#fff;" class="button button-primary"><a href="<?php echo $_SERVER['PHP_SELF'];?>?page=custom-coming-soon&mode=live-preview" target="_blank" style="color: #fff;text-decoration: none;">Live Preview</a></div>
                                ...
                                <form action="options.php" method="post" id="ccs-settings-form-admin">
                                    <div id="content" class="ccs-tab-section">
                                        ...
                                        <div class="ccs-content-div">
                                            ...
                                            <div>
                                                <label for="msg" class="ccs_lable">Meesage:</label>
                                                <br/>
                                                <div class="ccs_editor">
                                                <?php  wp_editor(esc_html( __(get_option('ccs_message', 'Coming soon ...'))), 'ccs_message', $settings);?>
                                                </div>
                                               </div>  
                                        </div>
                                    </div>
                                    ...
                                    <div id="Design" class="ccs-tab-section ccs-design">
                                        ...
                                        <div>
                                            <label for="image_url" class="ccs_lable" id="ccs_lable">Select Theme</label>
                                            <select name="ccs_theme" id="ccs_theme" class="select-box">
                                                <option value="Default">Default</option>
                                                <option value="SB">StaticBackground</option>
                                            </select>
                                         </div>
                                        <div>
...
/* Check preview start here*/
if(isset($_GET['mode'])=="live-preview")
{
	
      get_template_directory();
          if(get_option('ccs_theme')=="SB")
            {
            require dirname(__FILE__).'/themes/StaticBackground/ccs-static-background.php';
            }
            else
            {
            require dirname(__FILE__).'/themes/default/ccs-theme.php';
            } 
           exit;
}

/* Check preview ends here*/
